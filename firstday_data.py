...
#todo where did demographic come from/ labs
col_list = ['hadm_id', 'admission_type', 'gender', 'age']
demographic_data = pd.read_csv("C:/Users/Cathal Holloway/OneDrive - University of Birmingham/Masters/module7datastuff/demographic_data.csv", 'r',
...
vitals = pd.read_csv("C:/Users/Cathal Holloway/OneDrive - University of "
                     "Birmingham/Masters/module7datastuff/views/vitalsfirstday.csv", 'r', usecols=col_list,
                     delimiter=',')


col_list = ['hadm_id','bicarbonate_mean', 'bun_mean', 'wbc_mean', 'aniongap_mean', 'platelet_mean']
labs = pd.read_csv("C:/Users/Cathal Holloway/OneDrive - University of Birmingham/Masters/module7datastuff/views/labs_firstday_mean.csv",
                   'r', usecols=col_list, delimiter=',')

# gcs
col_list = ['hadm_id', 'mingcs']
gca = pd.read_csv("C:/Users/Cathal Holloway/OneDrive - University of Birmingham/Masters/module7datastuff/views/gcsfirstday.csv",
                  'r', usecols=col_list, delimiter=',')

# urine
col_list = ['hadm_id', 'urineoutput']
urine = pd.read_csv("C:/Users/Cathal Holloway/OneDrive - University of Birmingham/Masters/module7datastuff/views/uofirstday.csv",
                  'r', usecols=col_list, delimiter=',')

col_list = ['hadm_id', 'vent']
vent = pd.read_csv("C:/Users/Cathal Holloway/OneDrive - University of Birmingham/Masters/module7datastuff/views/ventfirstday.csv",
                  'r',  usecols=col_list, delimiter=',')
